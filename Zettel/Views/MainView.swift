...
struct MainView: View {
    ...
    private func shareNote() {
        // When showing a changelog, share the App Store link instead of the note text
        let activityItems: [Any]
        if noteStore.isShowingChangelog,
           let appStoreURL = URL(string: "https://apps.apple.com/app/id6748525244") {
